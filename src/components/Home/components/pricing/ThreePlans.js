...
const Plan = styled.div`
  ${tw`w-full max-w-sm mt-16 lg:mr-8 lg:last:mr-0 text-center px-8 rounded-lg relative pt-2 text-gray-900 bg-white flex flex-col`}
  .planHighlight {
...
const BuyNowButton = styled(PrimaryButtonBase)`
  ${tw`border-0 rounded-full uppercase tracking-wider py-4 w-full text-sm hover:shadow-xl transform hocus:translate-x-px hocus:-translate-y-px focus:shadow-outline`}
`;
...
export default ({
  ...
  description = "We care about your hard earned money, and makes sure every penny you invest makes worth it.",
  plans = null,
  ...
  const defaultPlans = [
    {
      ...
      features: [
        "Limited free videos",
        "2 free tests with detailed analasys",
    ...
    },
    {
      ...
      features: [
        ...
        "Tests with detailed analasys.",
        "Premium revision notes.",
        "Priority Assistance",
        "Access to students community potral",
      ],
      featured: true,
    },
    {
