...
const Container = tw.div`bg-pink-300 px-4 md:px-12 lg:px-20 pb-24`;
const ColumnContainer = tw.div`flex flex-col lg:flex-row md:items-center justify-between mb-16 md:mb-24`;

const Heading = tw.h1`text-center lg:text-left px-2 lg:pr-8 pt-12 md:pt-20 text-white font-medium font-poppins text-3xl md:text-5xl leading-tight`;
  ...
  return (
    <Container style={{ background: '#EE5351' }}>
      <ColumnContainer>
        ...
        <img tw='w-full lg:w-6/12 h-auto lg:h-112' src='/images/cmp2.png' />
      </ColumnContainer>
