...
export const GET_CHAPTERS = 'getChapters';
export const GET_CHAPTERS_SUCCESS = `${GET_CHAPTERS}.success`;
export const GET_CHAPTERS_FAILED = `${GET_CHAPTERS}.failed`;

export const GET_TOPICS = 'getTopics';
export const GET_TOPICS_SUCCESS = `${GET_TOPICS}.success`;
export const GET_TOPICS_FAILED = `${GET_TOPICS}.failed`;
